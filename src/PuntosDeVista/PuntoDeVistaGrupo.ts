        ...
        switch(evento.tipo) {
            case "veredicto":
                ...
                if(pastRanking!=tData.ranking_pos) {
                    this.emitir("El equipo "+evVer.equipo+" ("+evVer.id_equipo+") ha pasado de la posición "+pastRanking+" a la posición "+tData.ranking_pos+" del grupo "+this.nombre_grupo+" ("+this.id_grupo+")"+" después de recibir un "+evVer.resultado+" en el problema "+evVer.problema+" ("+evVer.id_problema+")");
                }
