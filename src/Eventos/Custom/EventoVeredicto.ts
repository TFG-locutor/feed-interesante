...
class EventoVeredicto extends Evento {
    ...
    constructor(_moment: string, id_envio: string, id_equipo:string, equipo: string, id_problema: string, problema: string, resultado: string, solved: boolean, penalty: boolean, n_intento: number) {
